...
//@AutoConfigureStubRunner - TO CONFIGURE
...
public class CheckoutApplicationTests {
    ...
    void should_checkout_order() throws Exception {
        ...
        mvc.perform(post("/v1/checkouts").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(order))).andExpect(status().isOk());
